...
- `get_manifest.result` must contain `protocol_version: 2`; `capabilities.health`, `capabilities.streaming`, `capabilities.send_rich`, `capabilities.typing`, `capabilities.reactions`, and `capabilities.read_receipts` are optional capability bits.
