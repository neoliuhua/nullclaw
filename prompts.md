...
- Stack (if code changes): Zig
- Goal and constraints: conversion, speed, brand vibe, accessibility level (WCAG AA?)
- What you have: screenshot,source codes for backend agent.
...
Prefer running it when the user wants a structured token output (Unicode-friendly).

## Output Standards
- Default uses Unicode.
...
generate codes in zig for the interfaces.
